...
<head>
  ...
  <meta name="description" content="Sekilas Tentang Prodi Studi Ilmu Aktuaria">


  <title>V.E ITK | ILMU AKTURIA</title>
...
<body>
  ...
  <section data-bs-version="5.1" class="menu cid-sJ47hcPjXG" once="menu" id="menu1-2j">
...
<section data-bs-version="5.1" class="gallery5 mbr-gallery cid-sJ47hfmcBE" id="gallery5-2k">
    ...
    <div class="container">
        <div class="mbr-section-head">
            <h3 class="mbr-section-title mbr-fonts-style align-center m-0 display-2"><strong>PROGRAM STUDI</strong><br><strong>ILMU AKTUARIA</strong></h3>
        </div>
        <div class="row">
            ...
            @foreach ( $konten as $k )
                <div class="col-12 col-md-6 col-lg-3 item gallery-image active">
                    <div class="item-wrapper" data-toggle="modal" data-bs-toggle="modal" data-target="#sJqqHUqxKX-modal" data-bs-target="#sJqqHUqxKX-modal">
                        <img class="w-100" src="{{ asset('/storage/' . $k->gambar) }}" alt="poster-polos" data-slide-to="0" data-bs-slide-to="0" data-target="#lb-sJqqHUqxKX" data-bs-target="#lb-sJqqHUqxKX">
        ...
        {{-- <div class="col-12 col-md-6 col-lg-3 item gallery-image">
            <div class="item-wrapper" data-toggle="modal" data-bs-toggle="modal" data-target="#sJqqHUqxKX-modal" data-bs-target="#sJqqHUqxKX-modal">
                <img class="w-100" src="{{ asset('assets/images/poster-polosss-696x465.png') }}" alt="poster-polos" data-slide-to="1" data-bs-slide-to="1" data-target="#lb-sJqqHUqxKX" data-bs-target="#lb-sJqqHUqxKX">
                <div class="icon-wrapper">
                    <span class="mobi-mbri mobi-mbri-search mbr-iconfont mbr-iconfont-btn"></span>
                </div>
            </div>
        ...
        <div class="col-12 col-md-6 col-lg-3 item gallery-image">
            <div class="item-wrapper" data-toggle="modal" data-bs-toggle="modal" data-target="#sJqqHUqxKX-modal" data-bs-target="#sJqqHUqxKX-modal">
                <img class="w-100" src="{{ asset('assets/images/poster-polosss-696x465.png') }}" alt="poster-polos" data-slide-to="2" data-bs-slide-to="2" data-target="#lb-sJqqHUqxKX" data-bs-target="#lb-sJqqHUqxKX">
                <div class="icon-wrapper">
                    <span class="mobi-mbri mobi-mbri-search mbr-iconfont mbr-iconfont-btn"></span>
                </div>
            </div>
            ...
            <div class="item-wrapper" data-toggle="modal" data-bs-toggle="modal" data-target="#sJqqHUqxKX-modal" data-bs-target="#sJqqHUqxKX-modal">
                <img class="w-100" src="{{ asset('assets/images/poster-polosss-696x465.png') }}" alt="poster-polos" data-slide-to="3" data-bs-slide-to="3" data-target="#lb-sJqqHUqxKX" data-bs-target="#lb-sJqqHUqxKX">
                <div class="icon-wrapper">
                    <span class="mobi-mbri mobi-mbri-search mbr-iconfont mbr-iconfont-btn"></span>
                </div>
            </div>
        ...
        <div class="modal mbr-slider" tabindex="-1" role="dialog" aria-hidden="true" id="sJqqHUqxKX-modal">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-body">
                        <div class="carousel slide" id="lb-sJqqHUqxKX" data-interval="5000" data-bs-interval="5000">
                            ...
                            <ol class="carousel-indicators">
                                <li data-slide-to="0" data-bs-slide-to="0" class="active" data-target="#lb-sJqqHUqxKX" data-bs-target="#lb-sJqqHUqxKX"></li>
                                <li data-slide-to="1" data-bs-slide-to="1" data-target="#lb-sJqqHUqxKX" data-bs-target="#lb-sJqqHUqxKX"></li>
                                <li data-slide-to="2" data-bs-slide-to="2" data-target="#lb-sJqqHUqxKX" data-bs-target="#lb-sJqqHUqxKX"></li>
                                <li data-slide-to="3" data-bs-slide-to="3" data-target="#lb-sJqqHUqxKX" data-bs-target="#lb-sJqqHUqxKX"></li>
                            </ol>
                            <a role="button" href="" class="close" data-dismiss="modal" data-bs-dismiss="modal" aria-label="Close">
                            </a>
                            <a class="carousel-control-prev carousel-control" role="button" data-slide="prev" data-bs-slide="prev" href="#lb-sJqqHUqxKX">
                                <span class="mobi-mbri mobi-mbri-arrow-prev" aria-hidden="true"></span>
                                <span class="sr-only visually-hidden">Previous</span>
                            </a>
                            <a class="carousel-control-next carousel-control" role="button" data-slide="next" data-bs-slide="next" href="#lb-sJqqHUqxKX">
...
<section data-bs-version="5.1" class="footer3 cid-sJ47hk2qQk" once="footers" id="footer3-2l">
